...
import { Terminal, ShieldCheck, Download, Sparkles } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({ onInstall, canInstall }) => {
  return (
        ...
        <div className="flex items-center gap-3">
          <div className="relative group">
            ...
            <div className="bg-gradient-to-br from-cyber-800 to-cyber-900 border border-cyber-700 p-2 rounded-xl relative">
              <Terminal className="w-6 h-6 text-cyber-400 group-hover:text-white transition-colors" />
            </div>
          </div>
          <div>
